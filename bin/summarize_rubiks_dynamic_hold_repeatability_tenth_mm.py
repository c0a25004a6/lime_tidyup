#!/usr/bin/env python3
"""Run the repeatability aggregator for the final ±0.10 mm boundary matrix."""
...
def write_diagnostic_failure(exc: Exception) -> None:
    ...
    for label, offset in TRIALS:
        ...
        if status_path.is_file():
            ...
            try:
                record["trial_exit_status"] = int(status_text)
            except ValueError:
                record["trial_exit_status"] = status_text
        ...
        if summary_path.is_file():
            ...
            try:
                ...
                record["contact_result"] = summary.get("contact_result")
                record["hold_result"] = summary.get("hold_result")
                record["release_result"] = summary.get("release_result")
